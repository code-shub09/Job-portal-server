...
// async function sendForgetMail(reciverEmail) {
//     const user = await User.findOne({ email: reciverEmail });
//     if (!user) {
...
//       <tr>
//         <td style="background-color: #1a365d; text-align: center; padding: 20px;">
//           <img src="cid:jobzilla_logo" alt="Company Logo" style="height: 40px;">
//         </td>
//       </tr>
//       <tr>
...
//             <a  style="background-color: #2563eb; color: white; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: bold;">
//               Reset Password
//             </a>
//           </p>
...
//       </tr>
//       <tr>
//         <td style="background-color: #f4f5f7; text-align: center; padding: 15px; font-size: 13px; color: #666;">
//           Contact us at 
//           <a href="mailto:support@yourdomain.com" style="color: #2563eb; text-decoration: none;">support@yourdomain.com</a> 
